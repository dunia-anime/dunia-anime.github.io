...
(function () {
    ...
    function Cb(a, b) {
        a.a = b;
        a.T && a.W ? (a.stop(), a.start()) : a.T && a.stop()
    }
    d.hb = function () {
        if (this.W) {
            var a = ja() - this.m;
            0 < a && a < .8 * this.a ? this.T = this.b.setTimeout(this.i, this.a - a) : (this.T && (this.b.clearTimeout(this.T), this.T = null), A(this, "tick"), this.W && (this.T = this.b.setTimeout(this.i, this.a), this.m = ja()))
        }
    };
    d.start = function () {
        this.W = !0;
        this.T || (this.T = this.b.setTimeout(this.i, this.a), this.m = ja())
    };
    d.stop = function () {
        this.W = !1;
        this.T && (this.b.clearTimeout(this.T), this.T = null)
    };
    d.P = function () {
        Bb.f.P.call(this);
        this.stop();
    ...
    d.P = function () {
        this.H && this.ea();
        this.V && (Ga(this.V), delete this.V);
        J(this, function (a) {
            Ga(a)
        });
        !this.ca && this.m && Qb(this.m);
        this.G = this.m = this.K = this.B = null;
        ic.f.P.call(this)
    };
    d.S = function (a, b) {
        var c = K(this);
    ...
    function zc(a) {
        ...
        var e = b.width / b.height,
            ...
            g = (a.L || !(null !== a.A || 1 == a.b.length)) && c.width < b.width && c.height < b.height,
            k = a.J;
        if (a.R && (c.width > b.width || c.height > b.height) || g || k) e = e > f, !k && e || k && !e ? (c.width = b.height * f, c.height = b.height) : (c.width = b.width, c.height = b.width / f);
    ...
    function Ec(a) {
        a.va = 0;
        a.I.W || (a.R = !0, a.ta(), A(a, "show"), a.I.start())
    }
    d.M = function (a) {
        Q.f.M.call(this, a);
        J(this, function (b) {
    ...
    d.ob = function () {
        this.va++;
        3 < this.va && (this.R = !1, this.ta(), A(this, "hide"), this.I.W && this.I.stop())
    };
    d.w = function () {
        Q.f.w.call(this);
    ...
    function Cd(a, b) {
        ...
        b.setAttribute("name", "search_iframe");
        var c = a.c();
    ...
    Ed.prototype.G = function (a) {
        ...
        this.V = R(q(a, "showDownloadButton"), this.V);
        this.h = R(q(a, "mediaitemsAspectRatio"), this.h);
        this.U = R(q(a, "mediaitemsEnlarge"), this.U);
    ...
    d.Wb = function (a) {
        this.g && (a.stopPropagation(), a.a(), this.h = !0, Pd(this))
    };
    d.Xb = function (a) {
        this.g && (a.stopPropagation(), a.a(), this.h = !1, Pd(this))
    };
    d.w = function () {
        Kd.f.w.call(this);
        var a = H(this);
    ...
    var le = window && (window.navigator.a || window.navigator.language).split("-")[0] || "en";

    function me(a) {
        return a[le] ? a[le] : a.en ? a.en : "%" + a + "%"
    };
    ...
    var se = "leftarrowclick",
        te = "rightarrowclick",
        ue = "linkbuttonclick",
        ve = "downloadbuttonclick";
    var we = new Gb(-3, -3, 24, 24),
        V = new Gb(-8, -8, 40, 40),
        xe = new T("M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z", V),
        ye = new T("M8.59 16.34l4.58-4.59-4.58-4.59L10 5.75l6 6-6 6z", V),
        ze = new T("M4.5 11H3v4h4v-1.5H4.5V11zM3 7h1.5V4.5H7V3H3v4zm10.5 6.5H11V15h4v-4h-1.5v2.5zM11 3v1.5h2.5V7H15V3h-4z", we),
        Ae = new T("M3 12.5h2.5V15H7v-4H3v1.5zm2.5-7H3V7h4V3H5.5v2.5zM11 15h1.5v-2.5H15V11h-4v4zm1.5-9.5V3H11v4h4V5.5h-2.5z", we),
        re = new T("M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z", V),
        qe = new T("M19 19H5V5h7V3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z",
            V),
        Be = new T("M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92 1.61 0 2.92-1.31 2.92-2.92s-1.31-2.92-2.92-2.92z", new Gb(-7, -8, 40, 40)),
        Ce = new T("M8 5v14l11-7z", V),
        De = new T("M6 19h4V5H6v14zm8-14v14h4V5h-4z", V),
        Ee = new T("M7 7h10v3l4-4-4-4v3H5v6h2V7zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2v4z",
            V),
        Fe = new T("M19 5H5c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 12H5V7h14v10z", V),
        Ge = new T("M19 7H5c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2zm0 8H5V9h14v6z", V),
        He = new T("M10 16.5l6-4.5-6-4.5v9zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z", V),
        Ie = new T("M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z", V);

    function Je(a, b, c) {
        M.call(this, c);
        c = this.i;
        this.b = new Gd(a || null, c);
        this.a = new Gd(b || null, c);
        this.A = !1;
        this.j = !0;
        this.l = this.o = !1;
        this.g = !0
    ...
    d.Yb = function (a) {
        this.j && (a.stopPropagation(), O(this) && this.g && W(this, !this.l), A(this, "click"))
    };
    d.Zb = function (a) {
        this.j && (a.stopPropagation(), this.o = !0, Ne(this))
    };
    d.$b = function (a) {
        this.j && (a.stopPropagation(), this.o = !1, Ne(this))
    };
    d.w = function () {
        Je.f.w.call(this);
        var a = H(this);
    ...
    function $e(a) {
        ...
        this.j = new U(Ie, a);
        this.s = new U(Be, a);
        this.h = new Se(De, Ce, a);
        this.g = new Se(Ee, Ee, a);
        this.a = new Se(Ge, Fe, a);
        this.b = new Se(Ae, ze, a)
    }
    p($e, ne);
    d = $e.prototype;
    d.$ = function (a) {
    ...
    var af = {
        ...
        cf = "sharebuttonclick",
        df = "playswitchclick",
        ef = "repeatswitchclick",
        ff = "fullpageswithcclick",
        gf = "fullscreenswithcclick";
    ...
    function of (a) {
        U.call(this, this.A(), a)
    }
    p( of , U); of .prototype.u = function () {
    ...
    rf.prototype.g = function (a) {
        ...
        if (B(this, "gmultitouchstart")) {
            var b = new X("gmultitouchstart", this, a);
            A(this, b)
        }
        a && 1 == a.length && (B(this, "gtouchhmove") || B(this, "gtouchvmove") ? (this.i.a = a[0].clientX, this.i.b = a[0].clientY, this.b = null) : B(this, "gtouchstart") && (b = new X("gtouchstart", this, a), A(this, b)), x(this.a, "touchmove", this.G, !1, this), x(this.a, "touchend", this.B, !1, this))
    };
    rf.prototype.G = function (a) {
        this.m = !0;
        var b = sf(a),
        ...
        if (c || e) {
            if (!this.b && (this.b = Math.abs(this.i.a - b[0].clientX) > Math.abs(this.i.b - b[0].clientY) ? 1 : 2, B(this, "gtouchstart"))) {
                var f = new X("gtouchstart", this, b);
                A(this, f)
            }
            c && 1 == this.b && (f = new X("gtouchhmove", this, b, a), A(this, f), a.stopPropagation(), a.a());
            e && 2 == this.b && (f = new X("gtouchvmove", this, b, a), A(this, f), a.stopPropagation(), a.a())
        }
        B(this, "gtouchmove") && (f = new X("gtouchmove", this, b, a), A(this, f));
        B(this,
            "gmultitouchmove") && (f = new X("gmultitouchmove", this, b), A(this, f), a.a())
    };
    rf.prototype.B = function (a) {
        a = sf(a);
        if (1 == a.length && (vb(this.a, "touchmove", this.G, !1, this), vb(this.a, "touchend", this.B, !1, this), B(this, "gtouchend"))) {
            var b = new X("gtouchend", this, a);
            A(this, b)
        }
        B(this, "gmultitouchend") && (b = new X("gmultitouchend", this, a), A(this, b));
    ...
    X.prototype.stopPropagation = function () {
        X.f.stopPropagation.call(this);
        this.B && this.B.cancelable && this.B.stopPropagation()
    };
    X.prototype.a = function () {
        X.f.a.call(this);
        this.B && this.B.cancelable && this.B.a()
    };
    ...
    function tf(a) {
        ...
        this.a = !1;
        this.g = 0;
        this.b = new rf(this.i.c());
        y(this.b, "gtouchstart", this.K, !1, this);
        y(this.b, "gtouchmove", this.G, !1, this);
        y(this.b, "gtouchend", this.B, !1, this)
    }
    p(tf, z);
    ...
    tf.prototype.G = function (a) {
        if (this.a) {
            ...
            8 < Math.abs(this.m - Math.abs(a.touches[0].clientY)) && (a.stopPropagation(), a.a());
            A(this, new uf("cgmove", b - this.g))
        }
    };
    ...
    d.ic = function () {
        var a = this.g.width * Df(this) * this.J;
    ...
    d.Va = function () {
        ...
        qd(If(this, this.a, -this.g.width * Df(this) * this.J, 0, !1));
    ...
    function zf(a) {
        if (0 != K(a))
            if (a.b != a.a && null != a.a) a.j = !0, null !== a.A && (a.Ya(), a.j = !1), Ff(a), Gf(a), a.j ? window.requestAnimationFrame(m(a.ic, a)) : a.Va(), a.A = setTimeout(m(a.Ya, a), 1.2 * a.I);
            else if (0 == a.a && 0 == a.b) {
            var b = L(a, 0);
            if (b) {
                var c = b.c();
    ...
    d = Mf.prototype;
    d.nc = function () {
        this.s && (this.l && this.o.reset(), A(this, "swipestart"))
    };
    d.mc = function (a) {
        if (this.s && (a = a.offset / this.g.width, !this.l)) {
            var b = 0 <= a ? -1 : 1;
            if (this.h != b) {
                this.h = b;
                b = this.a;
    ...
    d.lc = function (a) {
        if (this.s && this.h) {
            var b = (a = Math.abs(a.offset / this.g.width) > this.O) ? -this.h : 0,
                c = .001 * this.L + "s";
            Ef(L(this, this.b).c(), "left " + c + " ease-out");
            Ef(L(this, this.a).c(), "left " + c + " ease-out");
            Qf(this, b);
            this.l = setTimeout(m(this.dc, this), 1.2 * this.L);
            this.h = null;
    ...
    d.Ob = function () {
        this.L && window.open(this.L, "_blank")
    };
    d.Kb = function () {
        var a = Af(this.b).ga();
    ...
    d.Sb = function () {
        var a = nf(this.i);
        this.j !== a && (this.j = a, W(this.a.b, this.j), this.a.update());
        this.X()
    };
    d.jb = function (a) {
        switch (a.B) {
            ...
            case 80:
                ...
                break;
            case 27:
                this.l && (vg(this), W(this.a.a, this.D), a.a())
        }
    };
    d.w = function () {
        Y.f.w.call(this);
        y(this.a, hf, this.Nb, !1, this);
        y(this.a, jf, this.Qb, !1, this);
        y(this.a, kf, this.Ob, !1, this);
        y(this.a, lf, this.Kb, !1, this);
        y(this.a, bf, this.Jb, !1, this);
        y(this.a, cf, this.Rb, !1, this);
        y(this.a, df, this.Pb, !1, this);
        y(this.a, ef, this.kc, !1, this);
        y(this.a, ff, this.Lb, !1, this);
        y(this.a, gf, this.Mb, !1, this);
        y(this.a, "show", this.Qa, !1, this);
        y(this.a, "hide", this.Pa, !1, this);
        x(this.R, "resize", this.Sb, !1, this);
    ...
    d.w = function () {
        Ng.f.w.call(this);
        y(this.a, hf, this.xb, !1, this);
        y(this.a, jf, this.zb, !1, this);
        y(this.a, ue, this.yb, !1, this);
        y(this.a, ve, this.wb, !1, this);
